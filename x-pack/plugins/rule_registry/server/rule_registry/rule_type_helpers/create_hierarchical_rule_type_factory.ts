...
type CreateHierarchicalRuleType<TFieldMap extends DefaultFieldMap> = <
...
>(
  type: RuleType<
    ...
    TRuleParams,
    TActionVariable,
    { alertWithHierarchy: HierarchicalAlertService<TFieldMap, TActionVariable> }
  >
...
export function createHierarchicalRuleTypeFactory<
  TRuleRegistry extends RuleRegistry<DefaultFieldMap>
>(): TRuleRegistry extends RuleRegistry<infer TFieldMap>
  ? CreateHierarchicalRuleType<TFieldMap>
  : never;

export function createHierarchicalRuleTypeFactory(): CreateHierarchicalRuleType<DefaultFieldMap> {
  return (type) => {
    return {
      ...type,
